...
export function Game(props){
	return(
		<div className="card">
             <button alt="Add to favorite" className="favVg material-icons" onClick={() => props.addGameFavorite({title: props.name, id: props.id, img: props.img, genres: props.genres})}>star_outline</button>
